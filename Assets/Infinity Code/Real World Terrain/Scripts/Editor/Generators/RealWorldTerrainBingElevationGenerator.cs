        ...
        private void Download()
        {
            ...
            for (int x = 0; x < s; x++)
            {
                ...
                for (int y = 0; y < s; y++)
                {
                    ...
                    {
                        string partURL = string.Format(RealWorldTerrainCultureInfo.numberFormat, "http://dev.virtualearth.net/REST/v1/Elevation/Bounds?bounds={0},{1},{2},{3}&rows=32&cols=32&key={4}", ey, sx, sy, ex, key);
