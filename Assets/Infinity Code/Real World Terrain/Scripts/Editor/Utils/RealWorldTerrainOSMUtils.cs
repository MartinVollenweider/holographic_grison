...
namespace InfinityCode.RealWorldTerrain
{
    public static class RealWorldTerrainOSMUtils
    {
        ...
        /*public static RealWorldTerrainOSMWay GetWayByID(List<RealWorldTerrainOSMWay> ways, string id)
        {
            for (int i = 0; i < ways.Count; i++) if (ways[i].id == id) return ways[i];
            return null;
        }*/

        public static void LoadOSM(string _filename, out Dictionary<string, RealWorldTerrainOSMNode> _nodes, out Dictionary<string, RealWorldTerrainOSMWay> _ways, out List<RealWorldTerrainOSMRelation> _relations)
        {
            ...
            MoveRelationsToWays(_relations, _ways, _nodes);
        }
